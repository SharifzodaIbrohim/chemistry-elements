/**
 * SCANNERI ELEMENTHO — i18n (tg / ru / en)
 */
(function (global) {
  'use strict';
  const translations = {
    tg: {
      siteTitle: 'SCANNERI ELEMENTHO', navHome: 'Асосӣ', imgMissing: 'Сурат дастрас нест', subtitle: 'ҶАДВАЛИ ДАВРИИ ЭЛЕМЕНТХОИ ХИМИЯИ - 118 ЭЛЕМЕНТ',
      ...
      scientistsTitle: 'ОЛИМОНИ БУЗУРГ',
      lavoisierBio: 'Падари химияи муосир. Қонуни ҳифзи масса ва номи «оксиген».',
      boyleBio: 'Таърифи муосири модда. «Кимиёгори шаффоф».',
      curieBio: 'Ду ҷоизаи Нобел. Радий ва полоний.',
      paulingBio: 'Назарияи пайванди химиявӣ.',
      lomonosovBio: 'Михаил Василевич Ломоносов — олими бузурги рус, асосгузори химияи физикӣ дар Русия. Қонуни ҳифзи массаро мустақилона кашф кард, аввалин лабораторияи химиявиро дар Русия таъсис дод.',
      sharopovBio: 'Фарух Сафолбекович Шаропов (с. 1976) — химики тоҷик. Хатмкардаи факултаи химияи ДДТ. Муҳаққиқи равғанҳои эфирӣ ва маҳсулоти табиӣ. Аз соли 2021 дар рӯйхати 2% беҳтарин олимон дар ҷаҳон. Зиёда аз 100 мақолаи илмӣ.',
      saidaminovBio: 'Махсуд Саидаминов (с. 1988) — химики тоҷик, профессор. Мутахассиси маводи перовскитӣ. Таҷриба дар KAUST, MIT ва Донишгоҳи Торонто. Дар рӯйхати 2% беҳтарин олимон. Зиёда аз 170 мақолаи илмӣ.',
      formulasTitle: 'ФОРМУЛАҲО', footerInfo: 'Барои омӯзиш.', loading: 'Загрузка...'
    },
    ru: {
      siteTitle: 'SCANNERI ELEMENTHO', navHome: 'Главная', imgMissing: 'Фото недоступно', subtitle: 'ПЕРИОДИЧЕСКАЯ ТАБЛИЦА — 118 ЭЛЕМЕНТОВ',
      ...
      scientistsTitle: 'ВЕЛИКИЕ УЧЁНЫЕ',
      lavoisierBio: 'Отец современной химии. Закон сохранения массы и название «кислород».',
      boyleBio: 'Современное определение вещества. «Химик-скептик».',
      curieBio: 'Две Нобелевские премии. Радий и полоний.',
      paulingBio: 'Теория химической связи.',
      lomonosovBio: 'Михаил Васильевич Ломоносов — великий русский учёный, основатель физической химии в России. Независимо открыл закон сохранения массы, создал первую химическую лабораторию в России.',
      sharopovBio: 'Фарух Сафолбекович Шаропов (род. 1976) — таджикский химик. Выпускник химфака Таджикского госуниверситета. Исследователь эфирных масел и природных продуктов. С 2021 в списке 2% лучших учёных мира. Более 100 научных статей.',
      saidaminovBio: 'Махсуд Саидаминов (род. 1988) — таджикский химик, профессор. Специалист по перовскитам. Опыт в KAUST, MIT и Университете Торонто. В списке 2% лучших учёных мира. Более 170 научных статей.',
      formulasTitle: 'ФОРМУЛЫ', footerInfo: 'Для обучения.', loading: 'Загрузка...'
    },
    en: {
      siteTitle: 'SCANNERI ELEMENTHO', navHome: 'Home', imgMissing: 'Photo not available', subtitle: 'PERIODIC TABLE — 118 ELEMENTS',
      ...
      scientistsTitle: 'GREAT SCIENTISTS',
      lavoisierBio: 'Father of modern chemistry. Law of conservation of mass and the name oxygen.',
      boyleBio: 'Modern definition of substance. The Sceptical Chymist.',
      curieBio: 'Two Nobel Prizes. Radium and polonium.',
      paulingBio: 'Theory of chemical bonding.',
      lomonosovBio: 'Mikhail Vasilyevich Lomonosov — great Russian scientist, founder of physical chemistry in Russia. Independently discovered the law of conservation of mass, established the first chemistry laboratory in Russia.',
      sharopovBio: 'Farukh Safolbekovich Sharopov (b. 1976) — Tajik chemist. Graduate of Tajik State University Chemistry Faculty. Researcher of essential oils and natural products. In the world top 2% scientists list since 2021. Over 100 scientific papers.',
      saidaminovBio: 'Makhsud Saidaminov (b. 1988) — Tajik chemist, professor. Specialist in perovskite materials. Experience at KAUST, MIT and University of Toronto. In the world top 2% scientists list. Over 170 scientific papers.',
      formulasTitle: 'FORMULAS', footerInfo: 'For learning.', loading: 'Loading...'
    }
  };
  ...
  const quizQuestions = {
    tg: [
      ...
      { q: 'Рамзи нуқра (Silver) чӣ гуна аст?', o: ['Si', 'Sr', 'Ag', 'Au'], c: 2 },
      { q: 'Формулаи намаки ош кадом аст?', o: ['KCl', 'NaCl', 'CaCl₂', 'NaOH'], c: 1 },
      { q: '78% ҳаворо кадом газ ташкил медиҳад?', o: ['Оксиген', 'Азот', 'Карбон', 'Аргон'], c: 1 },
      { q: 'Элементи №1 кадом аст?', o: ['Гелий', 'Ҳидроген', 'Литий', 'Карбон'], c: 1 },
      { q: 'Алмаз ва графит аз кадом элемент иборатанд?', o: ['Si', 'C', 'B', 'N'], c: 1 },
      { q: 'Вазни атомии гидроген тақрибан чанд аст?', o: ['1', '12', '16', '23'], c: 0 },
      { q: 'Формулаи диоксиди карбон?', o: ['CO', 'CO₂', 'C₂O', 'O₂'], c: 1 },
      { q: 'Кадом элемент дар батареяҳои телефон истифода мешавад?', o: ['Литий', 'Натрий', 'Калий', 'Калсий'], c: 0 },
      { q: 'Рамзи мис (Copper)?', o: ['Co', 'Cu', 'Cr', 'Ca'], c: 1 },
      { q: 'Ягона металли моеъ дар ҳарорати хонагӣ?', o: ['Br', 'Hg', 'Ga', 'Cs'], c: 1 },
      { q: 'Рамзи уран?', o: ['Ur', 'U', 'Un', 'Us'], c: 1 },
      { q: 'Формулаи метан?', o: ['CH₄', 'C₂H₆', 'C₂H₄', 'C₂H₂'], c: 0 },
      { q: 'Кадом газ барои нафаскашӣ зарур аст?', o: ['N₂', 'CO₂', 'O₂', 'H₂'], c: 2 },
      { q: 'Рамзи алюминий?', o: ['Am', 'Al', 'As', 'Ar'], c: 1 },
      { q: 'Кадом элемент «подшоҳи заҳрҳо» ном дорад?', o: ['Pb', 'As', 'Hg', 'Cd'], c: 1 },
      { q: 'Ҷадвали давравиро кӣ кашф кард?', o: ['Лавуазье', 'Менделеев', 'Бойл', 'Кюри'], c: 1 },
      { q: 'Рамзи калсий?', o: ['Cl', 'Ca', 'Cs', 'Cr'], c: 1 },
      { q: 'Формулаи глюкоза?', o: ['C₆H₁₂O₆', 'C₁₂H₂₂O₁₁', 'CH₃OH', 'C₂H₅OH'], c: 0 },
      { q: 'Кадом элемент дар хамираи дандон истифода мешавад?', o: ['Cl', 'F', 'Br', 'I'], c: 1 },
      { q: 'Рамзи азот?', o: ['A', 'Az', 'N', 'No'], c: 2 }
    ],
    ru: [
      { q: 'Химическая формула воды?', o: ['H₂O', 'CO₂', 'O₂', 'NaCl'], c: 0 },
      { q: 'Символ кислорода?', o: ['O', 'O₂', 'O₃', 'OH'], c: 0 },
      { q: 'Символ водорода?', o: ['H', 'He', 'Hg', 'Ho'], c: 0 },
      { q: 'Символ железа?', o: ['Ir', 'Fe', 'In', 'I'], c: 1 },
      { q: 'Символ золота?', o: ['Go', 'Gd', 'Au', 'Ag'], c: 2 },
      { q: 'Символ серебра?', o: ['Si', 'Sr', 'Ag', 'Au'], c: 2 },
      { q: 'Формула поваренной соли?', o: ['KCl', 'NaCl', 'CaCl₂', 'NaOH'], c: 1 },
      { q: '78% воздуха составляет?', o: ['Кислород', 'Азот', 'Углерод', 'Аргон'], c: 1 },
      { q: 'Элемент №1?', o: ['Гелий', 'Водород', 'Литий', 'Углерод'], c: 1 },
      { q: 'Алмаз и графит состоят из?', o: ['Si', 'C', 'B', 'N'], c: 1 },
      { q: 'Атомная масса водорода примерно?', o: ['1', '12', '16', '23'], c: 0 },
      { q: 'Формула углекислого газа?', o: ['CO', 'CO₂', 'C₂O', 'O₂'], c: 1 },
      { q: 'Какой элемент в батареях телефонов?', o: ['Литий', 'Натрий', 'Калий', 'Кальций'], c: 0 },
      { q: 'Символ меди?', o: ['Co', 'Cu', 'Cr', 'Ca'], c: 1 },
      { q: 'Единственный жидкий металл при комнатной температуре?', o: ['Br', 'Hg', 'Ga', 'Cs'], c: 1 },
      { q: 'Символ урана?', o: ['Ur', 'U', 'Un', 'Us'], c: 1 },
      { q: 'Формула метана?', o: ['CH₄', 'C₂H₆', 'C₂H₄', 'C₂H₂'], c: 0 },
      { q: 'Какой газ нужен для дыхания?', o: ['N₂', 'CO₂', 'O₂', 'H₂'], c: 2 },
      { q: 'Символ алюминия?', o: ['Am', 'Al', 'As', 'Ar'], c: 1 },
      { q: 'Какой элемент называют «королём ядов»?', o: ['Pb', 'As', 'Hg', 'Cd'], c: 1 },
      { q: 'Кто открыл периодическую таблицу?', o: ['Лавуазье', 'Менделеев', 'Бойль', 'Кюри'], c: 1 },
    ...
    en: [
      ...
      { q: 'Symbol of oxygen?', o: ['O', 'O₂', 'O₃', 'OH'], c: 0 },
      { q: 'Symbol of hydrogen?', o: ['H', 'He', 'Hg', 'Ho'], c: 0 },
      { q: 'Symbol of iron?', o: ['Ir', 'Fe', 'In', 'I'], c: 1 },
      { q: 'Symbol of gold?', o: ['Go', 'Gd', 'Au', 'Ag'], c: 2 },
      { q: 'Symbol of silver?', o: ['Si', 'Sr', 'Ag', 'Au'], c: 2 },
      ...
      { q: 'Diamond and graphite are made of?', o: ['Si', 'C', 'B', 'N'], c: 1 },
      { q: 'Atomic mass of hydrogen is about?', o: ['1', '12', '16', '23'], c: 0 },
      { q: 'Formula of carbon dioxide?', o: ['CO', 'CO₂', 'C₂O', 'O₂'], c: 1 },
      { q: 'Which element is used in phone batteries?', o: ['Lithium', 'Sodium', 'Potassium', 'Calcium'], c: 0 },
      { q: 'Symbol of copper?', o: ['Co', 'Cu', 'Cr', 'Ca'], c: 1 },
      { q: 'Only liquid metal at room temperature?', o: ['Br', 'Hg', 'Ga', 'Cs'], c: 1 },
      { q: 'Symbol of uranium?', o: ['Ur', 'U', 'Un', 'Us'], c: 1 },
      { q: 'Formula of methane?', o: ['CH₄', 'C₂H₆', 'C₂H₄', 'C₂H₂'], c: 0 },
      { q: 'Which gas is needed for breathing?', o: ['N₂', 'CO₂', 'O₂', 'H₂'], c: 2 },
      { q: 'Symbol of aluminium?', o: ['Am', 'Al', 'As', 'Ar'], c: 1 },
      { q: 'Which element is called the king of poisons?', o: ['Pb', 'As', 'Hg', 'Cd'], c: 1 },
      { q: 'Who discovered the periodic table?', o: ['Lavoisier', 'Mendeleev', 'Boyle', 'Curie'], c: 1 },
  ...
  function setLanguage(lang) {
    ...
    document.querySelectorAll('.lang-btn, #langBar button[data-lang], button[data-lang]').forEach(btn => {
  ...
  function getElementData(symbol) {
    ...
    return langData[key] || (elementsI18n.tg[key] || null);
  }
